                      ...
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: borderRadius(),
                            border: Border.all(
                              color: (selectedTicket?.id ?? -1) == courseData.tickets[index].id ? blueF2() : greyE7,
                              width: 1
                            )
                          ),
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                height: 45,
                                decoration: BoxDecoration(
                                  color: (courseData.tickets[index].isValid ?? false) ? blueF2() : greyCF,
                                  shape: BoxShape.circle,
                                ),
                                alignment: Alignment.center,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: style12Regular().copyWith(color: blueF2()),
                                        )
                                      ],
                                    )
                                  ],
