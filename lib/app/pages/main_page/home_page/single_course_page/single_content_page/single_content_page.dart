...
class _SingleContentPageState extends State<SingleContentPage> {
  ...
  Future getData() async {
    ...
    // Validate content and link before making request
    if (content == null) {
    ...
    if (content?.link == null || content?.link?.isEmpty == true) {
      log("Error: Content link is null or empty");
      setState(() {
        isLoading = false;
      });
      return;
    ...
    log("Content Type: ${content?.type}");
    log("Content Link: ${content?.link}");
  ...
  Future getPreviousData() async {
    if (previousContentLink == null || previousContentLink!.isEmpty) {
      log("Previous content link is null or empty");
      return;
    }

    log("Previous Content Link: $previousContentLink");
    previousContentData =
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      space(8),
                      Text(
                        'The requested content is not available or has been removed.',
                        style:
                            style14Regular().copyWith(color: Colors.grey[600]),
                          ...
                          children: [
                            ...
                            if (isDripContent) ...{
                              ...
                              if (singleContentData?.storage == 'vimeo' ||
                                ...
                                // Debug information for YouTube videos
                                      ...
                                      ...List.generate(
                                        ...
                                        return horizontalChapterItem(
                                          ...
                                          singleContentData
                                              ...
                                              '',
                                          singleContentData?.attachments?[index]
                                                  .volume ??
                                              '',
                                          () {
                                            downloadSheet(
