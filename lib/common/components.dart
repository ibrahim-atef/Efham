                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: style14Regular().copyWith(color: blueF2()),
                    ),
                  ),
                ),
                        ...
                        if(isShowReward)...{
                          ...
                          Text(
                            (courseData.price == 0)
                              ...
                              : CurrencyUtils.calculator(courseData.price ?? 0),
                            style: style12Regular().copyWith(
                              color: (courseData.discountPercent ?? 0) > 0 ? greyCF : blueF2(),
                              decoration: (courseData.discountPercent ?? 0) > 0 ? TextDecoration.lineThrough : TextDecoration.none,
                              decorationColor: (courseData.discountPercent ?? 0) > 0 ? greyCF : blueF2(),
                            ),
                          ),
                        },
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: state ? blueF2() : greyCF,
            ),
            color: state ? blueF2() : Colors.white,
          ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    if(price.isNotEmpty)...{
                      Text(
                        price,
                        style: style16Regular().copyWith(color: blueF2()),
                      )
                    },
          ...
          child: Column(
            ...
            children: [
              ...
              LinearProgressIndicator(
                backgroundColor: blueF2().withOpacity(.2),
                value: progress,
                valueColor: AlwaysStoppedAnimation<Color>(blueF2()),
              ),
